...
from .views import Base, Detalle_dulce_v, Dulce_v, Receta3, actualizar_receta, bizcochito_grasa, eliminar_receta, figacita_manteca, panes_saborizados 
from . views import pan_campo, pan_viena, pionono, pan_salvado 
